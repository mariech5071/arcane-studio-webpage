    ...
    <div className='ml-12' id='catalog'>
      ...
      <br></br>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-3'>
          <div>
            <img src='/images/Project1.png' className='w-3/4 p-3'></img>
            <h2 className='font-bold'>Product 1</h2>
            <p>in est ante in nibh mauris</p>
          </div>
          <div>
            <img src='/images/Project2.png' className='w-3/4 p-3'></img>
            <h2 className='font-bold'>Product 2</h2>
            <p>in est ante in nibh mauris</p>
          </div>
          <div>
            <img src='/images/Project3.png' className='w-3/4 p-3'></img>
            <h2 className='font-bold'>Product 3</h2>
            <p>in est ante in nibh mauris</p>
          </div>
          <div>
            <img src='/images/Project4.png' className='w-3/4 p-3'></img>
